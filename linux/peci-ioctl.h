...
#define PECI_MBX_INDEX_SKT_PWR_THRTL_DUR                                       \
    11                                    /* Socket Power Throttled Duration */
...
#define PECI_IOC_RD_END_PT_CFG                                                 \
    _IOWR(PECI_IOC_BASE, PECI_CMD_RD_END_PT_CFG, struct peci_rd_end_pt_cfg_msg)

#define PECI_IOC_WR_END_PT_CFG                                                 \
    _IOWR(PECI_IOC_BASE, PECI_CMD_WR_END_PT_CFG, struct peci_wr_end_pt_cfg_msg)
